...
public class Team_promethean extends AppCompatActivity {
    ...
    private void loadData(){
        ...
        AndroidNetworking.post(Urls.team)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Team_adapter adapter = new Team_adapter(getApplicationContext(),team_models);
...
//        setAdapter();
    ...
    public class Team_adapter extends RecyclerView.Adapter<Team_adapter.Team_view> {

        Context context;
        private ArrayList<Team_model> depts_list;

        public Team_adapter(Context context, ArrayList<Team_model> depts_list) {
        ...
        @NonNull
        @Override
        public Team_adapter.Team_view onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.team_layout,parent,false);
            Team_adapter.Team_view cv = new Team_adapter.Team_view(view);
            return cv;
        }

        @Override
        public void onBindViewHolder(@NonNull final Team_adapter.Team_view holder, final int position) {
        ...
        class Team_view extends RecyclerView.ViewHolder{

            CircleImageView imageView;
            TextView name,contact,dept;
            ProgressBar progressBar;

            public Team_view(View itemView) {
                super(itemView);
